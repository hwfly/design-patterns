...
int main() {
    ...
    context = std::make_shared<Context>(std::make_shared<OperationSub>());
    std::cout << "10 - 5 = " << context->executeStrategy(10, 5) << std::endl;

    context = std::make_shared<Context>(std::make_shared<OperationMul>());
    std::cout << "10 * 5 = " << context->executeStrategy(10, 5) << std::endl;

    context = std::make_shared<Context>(std::make_shared<OperationDiv>());
    std::cout << "10 / 5 = " << context->executeStrategy(10, 5) << std::endl;
